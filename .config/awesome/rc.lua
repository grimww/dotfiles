...
beautiful.init(gears.filesystem.get_configuration_dir() .. "/themes/neon/theme.lua")
...
gui_editor     = os.getenv("GUI_EDITOR") or "emacs"
...
local myfavoritemenu = {
	...
	{ "Editor", gui_editor, menubar.utils.lookup_icon("accessories-text-editor") },
...
mymainmenu = freedesktop.menu.build({
	icon_size = 32,
	before = {
		{"Favorites", myfavoritemenu, menubar.utils.lookup_icon("package_favorite") },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create bottom tasklist widget
    s.mybottomtasklist = awful.widget.tasklist {
        screen   = s,
   ...
   -- Create the wibox
    --s.mywibox = awful.wibar({ position = "top", screen = s, opacity = 0.8, border_width = 10 })
    ...
    --s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, opacity = 0.8, border_width = 10 })
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Shift" }, "Alt_L", function () mykeyboardlayout.next_layout(); end,
              {description = "toggle keyboard layout", group = "keyboard layout"}),
    awful.key({ "Mod1" }, "Shift_L", function () mykeyboardlayout.next_layout(); end,
              {description = "toggle keyboard layout", group = "keyboard layout"}),
    -- https://wiki.archlinux.org/index.php/Awesome#Screenshot
    -- Screenshot
...
clientkeys = gears.table.join(
    ...
    -- https://wiki.archlinux.org/index.php/Awesome#Titlebars
